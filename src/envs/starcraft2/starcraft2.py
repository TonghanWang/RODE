...
class StarCraft2Env(MultiAgentEnv):
    ...
    def get_avail_agent_actions(self, agent_id):
        ...
        if unit.health > 0:
            ...
            # ##### WTH TEMP for 3s5z_vs_3s6z #################
            # stalker_all_died = True
            # zealot_all_died = True
            # for t_id, t_unit in target_items:
            #     if t_unit.health > 0:
            #         if t_id > 5:
            #             stalker_all_died = False
            #         else:
            #             zealot_all_died = False
            # ##### WTH TEMP for 3s5z_vs_3s6z #################
            ...
            for t_id, t_unit in target_items:
                if t_unit.health > 0:
                    ...
                    # ##### WTH TEMP for 3s5z_vs_3s6z #################
                    # if agent_id <= 2:
                    #     if t_id > 5 and (not zealot_all_died):
                    #         avail_actions[t_id + self.n_actions_no_attack] = 0
                    # else:
                    #     if t_id <= 5 and (not stalker_all_died):
                    #         avail_actions[t_id + self.n_actions_no_attack] = 0
                    # ##### WTH TEMP for 3s5z_vs_3s6z #################
